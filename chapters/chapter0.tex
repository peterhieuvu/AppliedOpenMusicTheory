...
\begin{document}
    ...
    The structure is not set in stone yet, but for now, we will go with a basic chapter structure. This is a template which will help with familiarity, but may not always be followed. When this book is further along, there will be more information. Eventually this will probably be moved to the preface instead. %TODO: check this
